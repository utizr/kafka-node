...
function encodeMessage (message) {
  var attributesInt = parseInt((message.timestampType << 3 | message.attributes >> 0).toString(2), 2);
  var m = new Buffermaker().Int8(message.magic).Int8(attributesInt);

  if (message.magic && message.timestamp) {
